...
--
-- The same sweep as 0009, run again: three migrations since then added tables
-- without it (coordination, coordination_grants, admin_audit, and
-- push_subscriptions), which rls.test.ts now flags. A migration fixes today;
-- the test is what keeps the next table from slipping through.
