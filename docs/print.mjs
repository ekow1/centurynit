...
body {
	...
	font-size: 10pt; line-height: 1.62; color: #1c1c1c; margin: 0;
	hyphens: auto;
}

/* — Cover — */
.cover { page: cover; break-after: page; height: 245mm;
	display: flex; flex-direction: column; justify-content: center; }
.cover .brand { font-size: 9pt; letter-spacing: 0.34em; text-transform: uppercase;
	color: #777; margin-bottom: 34pt; }
.cover .rule { width: 42pt; border-top: 2.5pt solid #1c1c1c; margin-bottom: 26pt; }
.cover h1 { font-family: Georgia, "Times New Roman", serif; font-weight: 400;
	font-size: 34pt; line-height: 1.22; margin: 0 0 20pt; color: #1c1c1c; }
...
h2 {
	...
	font-size: 19pt; color: #1c1c1c; margin: 0 0 4pt;
	break-before: page; text-align: left;
	padding-bottom: 10pt; border-bottom: 0.8pt solid #1c1c1c;
}
h2 .kicker { display: block; font-family: "Segoe UI", sans-serif;
	font-size: 8pt; letter-spacing: 0.3em; text-transform: uppercase;
	color: #999; margin-bottom: 10pt; }
h2 + p { margin-top: 14pt; }
h3 {
	font-family: Georgia, serif; font-weight: 400; font-size: 12pt;
	margin: 20pt 0 6pt; break-after: avoid; color: #1c1c1c;
	font-variant: small-caps; letter-spacing: 0.05em; text-align: left;
}
p { margin: 6pt 0; orphans: 3; widows: 3; }
ul, ol { margin: 6pt 0 10pt; padding-left: 17pt; }
li { margin: 3.5pt 0; padding-left: 2pt; }
li::marker { color: #999; }
