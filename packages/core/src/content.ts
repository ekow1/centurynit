import { PORTAL_STEP, CHAPTER_LABELS } from "century-nit-shared";
...
export const PROCESS_STAGES: {
	...
	},
	{
		...
		detail: "Your consultant's assessment and recommendation",
		owner: "counselor",
		path: "/portal/consultation",
		band: "consultation",
	},
	...
	},
	{
		...
		detail: "Package, payment plan and deposit",
		owner: "you",
		path: "/portal/package",
		band: "application",
	},
	...
	},
	{
		...
		detail: "Choose your schools and programmes",
		owner: "you",
	...
	},
	{
		...
		detail: "Your consultant is preparing the application fee",
		owner: "counselor",
		path: "/portal/application",
		band: "application",
	},
	{
		...
		detail: "Pay the application fee to start submissions",
		owner: "you",
		path: "/portal/application",
		band: "application",
	},
	{
		...
		detail: "Submissions, decisions and offers",
		owner: "counselor",
		path: "/portal/application",
		band: "application",
	},
	{
		...
		detail: "Pay the visa fee to open your visa case",
		owner: "you",
		path: "/portal/visa",
		band: "visa",
	},
	{
		...
		detail: "Biometrics, decision, outcome",
		owner: "counselor",
		path: "/portal/visa",
		band: "visa",
	},
	...
	},
	{
		...
		detail: "Flight, ticket and pre-departure checklist",
		owner: "counselor",
...
export const PORTAL_CHAPTERS: {
	id: PortalChapterId;
	/** The six-chapter numeral this page belongs to (two pages can share one). */
	step: string;
	label: string;
	blurb: string;
	unlockHint: string;
...
}[] = [
	{
		...
		step: "⌂",
		label: "Home",
		blurb: "What's happening now",
		unlockHint: "Always open",
		path: "/portal/home",
	},
	// The pages follow the vocabulary's six chapters (CHAPTERS in
	// century-nit-shared). Where a chapter spans two pages, both carry its
	// numeral and the page says which part it is.
	{
		id: "consultation",
		step: "I",
		label: CHAPTER_LABELS.consult,
		blurb: "Meet, assess, verify documents",
	...
	},
	{
		id: "package",
		step: "II",
		label: CHAPTER_LABELS.enrol,
		blurb: "Confirm, package, plan, deposit",
	...
	},
	{
		id: "application",
		step: "III",
		label: CHAPTER_LABELS.apply,
		blurb: "Choose schools · application fee",
		unlockHint: "Unlocks after enrolment",
		path: "/portal/application",
	},
	{
		id: "tracking",
		step: "III",
		label: `${CHAPTER_LABELS.apply} · Offers`,
		blurb: "Submissions · offers",
		unlockHint: "Unlocks once the application fee is paid",
		path: "/portal/tracking",
	},
	{
		id: "visa",
		step: "IV",
		label: CHAPTER_LABELS.visa,
		blurb: "Fee, biometrics, decision",
		unlockHint: "Unlocks when you're admitted",
		path: "/portal/visa",
	},
	// Departure: the fee milestone first (due once the visa is approved,
	// before the ticket), then the flight.
	{
		id: "payment_execution",
		step: "V",
		label: `${CHAPTER_LABELS.depart} · Fees`,
		blurb: "Pre-departure fee milestone",
		unlockHint: "Unlocks once your visa is approved",
		path: "/portal/payment-execution",
	},
	{
		id: "travel_assistance",
		step: "V",
		label: `${CHAPTER_LABELS.depart} · Flight`,
		blurb: "Flight & pre-departure checklist",
		unlockHint: "Unlocks once your visa is approved",
		path: "/portal/pre-departure",
	},
	{
		id: "complete",
		step: "VI",
		label: CHAPTER_LABELS.done,
		blurb: "Departed; post-arrival plan",
		unlockHint: "Unlocks when everything is settled",
		path: "/portal/complete",
	},
];
